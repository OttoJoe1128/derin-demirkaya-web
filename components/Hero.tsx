    ...
    <section className="flex flex-col items-center justify-center min-h-[80vh] px-6 py-12 text-center max-w-7xl mx-auto">
      <div className="w-full max-w-3xl space-y-8 animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
          <button className="bg-primary hover:bg-neutral-800 text-neutral-50 px-8 py-3 text-sm uppercase tracking-widest transition-all duration-300">
            Koleksiyon
          </button>
          <button className="border border-primary text-primary hover:bg-neutral-100 px-8 py-3 text-sm uppercase tracking-widest transition-all duration-300">
            Atölye Takvimi
          </button>
        </div>
      </div>
